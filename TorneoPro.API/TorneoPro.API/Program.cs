...
using TorneoPro.API.Servicios.Implementaciones.Arbitro;
...
builder.Services.AddScoped<IEnlaceService, EnlaceService>();
builder.Services.AddSingleton<IEstadisticaEnVivoService, EstadisticaEnVivoService>();
